...
```
server {
    server_name tomcat.antarcris.cl;
    ...
    ssl_certificate /etc/letsencrypt/live/repository.antarcris.cl/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/repository.antarcris.cl/privkey.pem; # managed by Certbot
